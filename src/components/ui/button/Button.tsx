...
const Button: FC<PropsWithChildren<ComponentProps<'button'> & Props>> = function ({
  ...
  const finalClass = cn(
    'rounded-md bg-black text-slate-200 font-medium border border-transparent hover:border-sky-500 px-1 sm:px-3 py-1 focus:ring-4 ring-slate-500 ring-2 transition-colors',
